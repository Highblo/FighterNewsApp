    ...
    <Flex justify="center" align="center" minH="88vh">
      <Box maxW="1200px" p={2} mt={{ base: 3, md: 0 }}>
        ...
        <Box textAlign="center" p={4} mb={8}>
          <ExplanationText text1="*使用技術" text2="HTML/CSS/Javascript" />
          <ExplanationText text1="*製作期間" text2="1週間" />
          <Box mb={2}>
            <Text fontWeight="bold" fontSize="lg">
              *こだわったポイント
            </Text>
            <Text>
              HTML、CSS、Javascriptを学んでから初めて作った作品になります。
              <br />
              トップページにはアイコンを大量に表示し、CSSanimationで動きをつけるようにしました。
              <br />
              hover時はカラーを付けて足跡のようなものを表現できました。
              <br />
              ガラスカードを作成し、よりガラスのよう動きを表現できるようにvanila
              tilt jsライブラリを取り入れました。
            </Text>
          </Box>
          <ExplanationText
            text1="*課題"
